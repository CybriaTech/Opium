...
Game.prototype.initialize = function() {
    ...
    app.on('game:share', function () {
        ...
        var shareText = encodeURIComponent("I scored " + this.score + " in Flappy Bird! Beat that! https://opium-games.com/games/flappybird/ Powered by CybriaTech #webgl #html5 #opium #cybriatech");
